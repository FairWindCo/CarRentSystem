...
class StatisticsType(models.IntegerChoices):
    ...
    TRIP_STAT_DAY_PAID = 10, 'Статистика по поездкам и оплата по дням'
    TRIP_PAID_DAY_STAT = 20, 'Оплата по поездкам и статистика по дням'
...
class RentPrice(models.Model):
    ...
    statistics_type = models.PositiveIntegerField(choices=StatisticsType.choices, default=StatisticsType.TRIP_STAT_DAY_PAID,
