    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_millage', models.PositiveIntegerField(default=7, verbose_name='Срок аренды для расчета стоимости залога')),
                ('plan_amount', models.FloatField(default=600, verbose_name='План по кассе')),
                ('trips_control', models.BooleanField(verbose_name='Контроль за количеством поездок')),
                ('millage_control', models.BooleanField(verbose_name='Контроль за километражем')),
                ('amount_control', models.BooleanField(verbose_name='Контроль за суммой кассы')),
                ...
                ('control_interval_paid_distance', models.PositiveIntegerField(default=1, verbose_name='Контрольный интервал')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stat_date', models.DateField(default=datetime.datetime(2022, 1, 30, 17, 7, 38, 744835, tzinfo=utc), verbose_name='Дата')),
