...
from request_processor.value_converters_utility import PrototypeDescription
...
class PrototypeDescriptionTest(unittest.TestCase):
    ...
    def test_convert_from_string(self):
        prototype = PrototypeDescription.parse_one('test')
    ...
    def test_convert_from_complex_string(self):
        prototype = PrototypeDescription.parse_one('field_name::default_value::method::result_field')
    ...
    def test_convert_from_dict(self):
        prototype = PrototypeDescription.parse_one({
    ...
    def test_convert_from_array_with_not_string(self):
        prototype = PrototypeDescription.parse_one(['field_name', 5, 'method', 'result_field'])
    ...
    def test_convert_from_string_complex(self):
        prototypes = PrototypeDescription.from_description('test1, test2 , test 3')
    ...
    def test_convert_from_string_complex2(self):
        prototypes = PrototypeDescription.from_description('testf::default_value1::method1::result_field1, '
    ...
    def test_field_path(self):
        prototypes = PrototypeDescription('field1__field2__field3')
        self.assertEqual(prototypes.field_path, ['field1', 'field2', 'field3'])

    def test_field_path_suffix(self):
        prototypes = PrototypeDescription('field5__field6__field7__lt')
    ...
    def test_convert_from_complex_dict(self):
        prototypes = PrototypeDescription.from_description({
    ...
    def test_get_value_1(self):
        prototypes = PrototypeDescription('field_1')
        obj = ExampleClass()
    ...
    def test_get_value_2(self):
        prototypes = PrototypeDescription('field_2__1')
        obj = ExampleClass()
    ...
    def test_get_value_3(self):
        prototypes = PrototypeDescription('field_2__0')
        obj = ExampleClass()
        self.assertEqual(prototypes.field_path, ['field_2', '0'])
        self.assertEqual(prototypes.get_object_member(obj), 10)

    def test_get_value_4(self):
        prototypes = PrototypeDescription('field_6__test6__test1.1')
        obj = ExampleClass()
    ...
    def test_get_value_default_1(self):
        prototypes = PrototypeDescription('field_55__test6__test1.1', 35)
        obj = ExampleClass()
    ...
    def test_get_value_default_2(self):
        prototypes = PrototypeDescription('field_66__test66__test1.1', 35)
        obj = ExampleClass()
        self.assertEqual(prototypes.field_path, ['field_66', 'test66', 'test1.1'])
        self.assertEqual(prototypes.get_object_member(obj), 35)

    def test_get_value_default_3(self):
        prototypes = PrototypeDescription('field_55__test6__test1.1', None)
        obj = ExampleClass()
        self.assertEqual(prototypes.field_path, ['field_55', 'test6', 'test1.1'])
    ...
    def test_get_converted_value_str_to_date(self):
        format = '%d/%m/%Y %H:%M:%S'
        prototypes = PrototypeDescription('field_4', None, 'datetime_%d/%m/%Y %H:%M:%S', 'result')
        obj = ExampleClass()
    ...
    def test_get_converted_value_date_to_str(self):
        format = '%d/%m/%Y %H:%M:%S'
        prototypes = PrototypeDescription('field_7', None, 'datetime_%d/%m/%Y %H:%M:%S', 'result')
        obj = ExampleClass()
    ...
    def test_get_converted_value_str_to_float(self):
        prototypes = PrototypeDescription('field_8', None, 'float', 'result')
        obj = ExampleClass()
        self.assertEqual(prototypes.get_result_value(obj), ('result', obj.field_5))

    def test_get_converted_value_float_to_str(self):
        prototypes = PrototypeDescription('field_5', None, 'format_{:.2f}', 'result')
        obj = ExampleClass()
