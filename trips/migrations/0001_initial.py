    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateTimeField(default=datetime.datetime(2022, 1, 31, 18, 29, 51, 847101, tzinfo=utc), verbose_name='Дата начала поездки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stat_date', models.DateField(default=datetime.datetime(2022, 1, 31, 18, 29, 51, 847101, tzinfo=utc), verbose_name='Дата')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stat_date', models.DateField(default=datetime.datetime(2022, 1, 31, 18, 29, 51, 905549, tzinfo=utc), verbose_name='Дата')),
